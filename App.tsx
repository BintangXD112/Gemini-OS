...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-800 to-gray-900 w-full min-h-screen p-4 overflow-hidden relative">
      <Window
        title={windowTitle}
        ...
        <div
          ...
          {isParametersOpen ? (
            ...
            <>
              {isGeneratingImage && (
                <div className="absolute inset-0 bg-white/70 backdrop-blur-sm flex flex-col items-center justify-center z-10 rounded-b-lg">
                  <div className="animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-blue-500"></div>
                  <p className="llm-text mt-4">Generating your masterpiece...</p>
                </div>
              )}
